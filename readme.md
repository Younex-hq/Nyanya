...
- **Tag Management (Tag Forge)**: Categorize your focus sessions with custom tags, colors, and specific session durations.
- **Dynamic Theming**: The application's UI color dynamically updates to match the color of your active tag.
...
- **Visual Analytics**:
  ...
  - **Yearly Activity Heatmap**: Track your long-term focus consistency.
